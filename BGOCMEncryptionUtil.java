package oracle.apps.bgocm.service.oid;
...
public class BGOCMEncryptionUtil {
    ...
    public static void main(String arg[]){
        try{
            BGOCMEncryptionUtil ed = new BGOCMEncryptionUtil();
            System.out.println(""+ed.encrypt("stgs2madm2n"));
            //System.out.println(""+ed.decrypt("8tRbLZ9bl1c7VzTFTl1bQQ=="));
        }catch(Exception e){
            e.printStackTrace();
        }
    }
